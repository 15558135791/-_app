        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 在进行路由跳转之前，发请求把购买产品的信息通过请求的形式通知服务器，服务器进行相应的存储 -->
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      try {
        ...
        // 2.服务器存储成功，通过路由跳转传递参数
        //产品信息skuinfo比较复杂，通过会话存储（不持久，会话结束数据消失）
        //本地存储 | 会话存储的 一般是字符串  需要通过JSON.stringify()转换为字符串
